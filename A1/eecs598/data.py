...
def cifar10(num_train=None, num_test=None):
  ...
  dset_train = CIFAR10(root='./eecs598/', download=download, train=True) # set train to be TRUE, the dataset will come from train set
  dset_test = CIFAR10(root='./eecs598/', train=False) # set train to be FALSE, the dataset will come from train set
